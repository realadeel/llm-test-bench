...
test_cases:
  - name: "Specific Image Test"
    ...
    image_path: "test_images/album_cover.jpg"  # Process only this image
```
...
```json
{
  ...
  "image_results": [
    ...
    {
      "image_path": "test_images/book.jpg",
      "provider_results": [...]
    }
  ]
}
  ...
  - name: "Smart Item Analysis"
    ...
    tools:
      - name: "analyze_vinyl_record"
        description: "For vinyl records, LPs, and music albums with cover art"
        schema:
          type: "object"
          properties:
            ...
            record_label: {type: "string", description: "Record label"}
          required: ["title", "artist"]
          
      - name: "analyze_book"
        description: "For books, magazines, and publications"
        schema:
          type: "object"
          properties:
            title: {type: "string", description: "Book title"}
            author: {type: "string", description: "Author name"}
            publisher: {type: "string", description: "Publishing company"}
            isbn: {type: "string", description: "ISBN if visible"}
          required: ["title", "author"]
          
      - name: "analyze_collectible"
        description: "For toys, memorabilia, and other collectible items"
        schema:
          type: "object"
          properties:
            title: {type: "string", description: "Item name or description"}
            brand: {type: "string", description: "Brand or manufacturer"}
            category: {type: "string", description: "Type of collectible"}
...
```json
{
  "item_type": "analyze_vinyl_record",
  "title": "OK Computer", 
  "artist": "Radiohead",
